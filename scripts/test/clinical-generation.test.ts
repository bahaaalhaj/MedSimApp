...
test('committed derived clinical payloads match their pre-refactor semantics', () => {
  ...
  assert.equal(sha256(withoutGeneratedMetadata(localAi)), 'e72f06384ea0fcb26a964d045e3ce9855578d06262306d7794c94a752368be45');
...
test('all generators are stable and preserve the pre-refactor clinical semantics', () => {
  ...
  assert.equal(jsonSemanticSha256(buildLocalAiSemanticPayload()), 'e72f06384ea0fcb26a964d045e3ce9855578d06262306d7794c94a752368be45');
