...
This loop is intentionally narrow. It does NOT generate new cases, touch the 3D scene, or modify local-model prompts. It verifies the things that tend to regress silently during development.
...
- Don't invoke a real local model. This loop is about the repo, not live game state.
