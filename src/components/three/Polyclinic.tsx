 ...
 *  current polyclinic patient and uses the cozy MedSim palette. */
function makeMonitorTexture(patient: MonitorPatient | null): CanvasTexture {
  ...
  ctx.fillText('MedSim · Patient Record', 14, 26);
...
export function Polyclinic({
  ...
  return (
    <>
      ...
      {/* Patient subtitle/audio panel — anchored above the seated patient's
      ...
      {patientAudioVisible && patient && (
        <FloatingPatientAudioPanel
